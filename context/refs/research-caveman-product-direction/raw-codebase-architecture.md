...
Key findings:
- Monorepo with 10 packages, fork of badlogic/pi-mono renamed to Caveman Code Pi
- Binary: `caveman` and `pi` aliases, both point to same compiled entry
...
- Caveman Code mode: 3-layer compression (system prompt + tool output + optional RTK)
