# Raw Findings: Distribution & Viral Features
...
- OSS weekend gate active, approved contributors list
- ASCII art logo implemented, brand colors in dark.json
- No /cave toggle command yet — users must edit settings.json
- Upstream logo still in npm-facing README
- PRD Phase 6 launch plan exists but unexecuted
- 50+ example extensions (doom overlay, space invaders, git checkpoint)
