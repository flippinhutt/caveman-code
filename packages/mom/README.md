...
Update mom anytime with `npm install -g @caveman-code/mom`. This only updates the Node.js app on your host. Anything mom installed inside the Docker container remains unchanged.
