...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@caveman-code/ai`, `@caveman-code/agent`, `caveman`, `@caveman-code/tui`, `@sinclair/typebox`.
